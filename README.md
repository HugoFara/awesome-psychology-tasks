...
| Useful Field of View (UFOV) | Identify a central target while localizing a peripheral target. Measures spatial extent of attentional processing. | Ball et al., 1988 | [Ms](https://www.millisecond.com/download/library/ufov/) |
| Global/Local (Navon) Task | Identify the global or local level of hierarchical stimuli (large letter made of small letters). | Navon, 1977 | [PT](https://www.psytoolkit.org/experiment-library/navon.html) · [Ms](https://www.millisecond.com/download/library/navon/) |
| Inhibition of Return (IOR) | Posner cueing variant with long intervals — slower RTs at previously cued locations. | Posner & Cohen, 1984 | [Ms](https://www.millisecond.com/download/library/ior/) |
...
| Sustained Attention to Response Task (SART) | Respond to every stimulus except an infrequent target (reverse CPT). Commission errors index attention lapses and mind-wandering. | Robertson et al., 1997 | [PT](https://www.psytoolkit.org/experiment-library/sart.html) · [Ms](https://www.millisecond.com/download/library/sart/) |
| Rapid Visual Information Processing (RVP) | Detect target sequences (e.g., three consecutive odd numbers) in a pseudo-random digit stream. Measures sustained visual attention. | Sahakian & Owen, 1992 | [PsychoPy](https://github.com/ccraddock/RVIP) |
| Negative Priming | Respond to a target that was a distractor on the preceding trial. Slowed RTs reflect lingering inhibition of previously ignored stimuli. | Tipper, 1985 | [Ms](https://www.millisecond.com/download/library/negativepriming/) |
...
| RSVP Single-Target Detection | Detect a single target in a rapid stream of items (~10/sec). Measures temporal attention resolution. | Potter, 1975 | [EF](https://github.com/expfactory-experiments/rsvp-task) |
...
| Digit Span (Forward/Backward) | Repeat digit sequences in order or reverse. Forward = storage; backward = storage + manipulation. | Wechsler, 1939 | [PT](https://www.psytoolkit.org/experiment-library/digitspan.html) · [Ms](https://www.millisecond.com/download/library/digitspan/) · [EF](https://github.com/expfactory-experiments/digit-span) |
| Operation Span (OSPAN) | Alternate between math problems and remembering items. Measures WM capacity under dual-task load. | Turner & Engle, 1989 | [Ms](https://www.millisecond.com/download/library/ospan/) |
| Change Detection (Visual WM) | Judge whether an item changed in a briefly viewed array after a delay. Estimates visual WM capacity (Cowan's K). | Luck & Vogel, 1997 | [Ms](https://www.millisecond.com/download/library/changedetection/) |
| Paired Associates Learning | Learn arbitrary pairs (e.g., word–word); tested via cued recall. Measures associative memory binding. | Calkins, 1894 | [Ms](https://www.millisecond.com/download/library/pairedassociates/) |
| Deese-Roediger-McDermott (DRM) | Study semantically related words; frequently falsely recall/recognize the non-presented critical lure. | Roediger & McDermott, 1995 | [Ms](https://www.millisecond.com/download/library/drm/) |
| Rey Auditory Verbal Learning Test (RAVLT) | 15-word list across five learning trials, interference list, delayed recall. Measures verbal learning and retention. | Rey, 1941 | [Ms](https://www.millisecond.com/download/library/ravlt/) |
...
| Reading Span | Read sentences while remembering final words. Measures WM capacity in a language context. | Daneman & Carpenter, 1980 | [Ms](https://www.millisecond.com/download/library/readingspan/) |
| Directed Forgetting | Some items cued "forget," others "remember." Comparing memory for each reveals intentional memory control. | Bjork, 1970 | [Ms](https://www.millisecond.com/download/library/directedforgetting/) |
| Prospective Memory | Remember to perform a future action while engaged in an ongoing task. | Einstein & McDaniel, 1990 | [PsychoPy](https://github.com/mcvinding/PM_volition) |
...
| Verbal Fluency (FAS / Category) | Generate words starting with a letter or from a category within a time limit. | Thurstone, 1938 | [Ms](https://www.millisecond.com/download/library/verbalfluency/) |
| AX-CPT | Respond to A-then-X sequences; measures proactive vs. reactive cognitive control. | Braver et al., 2001 | [Ms](https://www.millisecond.com/download/library/axcpt/) · [TB](https://github.com/TaskBeacon/H000001-ax-cpt) |
...
| Task | Description | Key Reference | Implementations |
|------|-------------|---------------|-----------------|
| Iowa Gambling Task (IGT) | Choose from four decks with varying reward/punishment. Measures affective decision-making under ambiguity. | Bechara et al., 1994 | [PT](https://www.psytoolkit.org/experiment-library/igt.html) · [Ms](https://www.millisecond.com/download/library/iowagamblingtask/) |
| Balloon Analogue Risk Task (BART) | Pump a virtual balloon for increasing reward; risk losing all if it pops. Indexes risk-taking propensity. | Lejuez et al., 2002 | [PT](https://www.psytoolkit.org/experiment-library/bart.html) · [Ms](https://www.millisecond.com/download/library/bart/) · [TB](https://github.com/TaskBeacon/H000002-bart) |
| Delay Discounting | Choose between smaller-sooner and larger-later rewards. Discounting steepness measures impulsivity. | Mazur, 1987 | [Ms](https://www.millisecond.com/download/library/delaydiscounting/) |
| Cambridge Gambling Task (CGT) | Bet on outcomes with explicit probabilities displayed. Separates risk-taking from learning. | Rogers et al., 1999 | [PsychoPy](https://github.com/jspickering/Experiments) |
| Ultimatum Game | Proposer splits money; responder accepts or rejects. Measures fairness norms and punishment. | Guth, Schmittberger, & Schwarze, 1982 | [Ms](https://www.millisecond.com/download/library/ultimatumgame/) |
...
| Prisoner's Dilemma | Cooperate or defect; iterated versions measure cooperation strategies. | Axelrod, 1984 | [Ms](https://www.millisecond.com/download/library/prisonersdilemma/) |
...
| Effort-Based Decision Making (EEfRT) | Choose low-effort/low-reward vs. high-effort/high-reward tasks. Measures motivation and effort discounting. | Treadway et al., 2009 | [jsPsych](https://github.com/belieflab/eEfRT) · [PsychoPy](https://github.com/bizerkmaverick/EEfRT-9-9-16) |
| Trolley Dilemma | Decide whether to divert a trolley to kill one person to save five. Classic moral dilemma indexing utilitarian reasoning. | Foot, 1967; Greene et al., 2001 | [Ms](https://www.millisecond.com/download/library/trolley/) |
...
| Decisions from Experience | Participants sample from payoff distributions before choosing, rather than seeing described probabilities. Reveals the description–experience gap. | Hertwig et al., 2004 | [PsychoPy](https://github.com/sappelhoff/sp_experiment) |
| Beads Task (Jumping to Conclusions) | Draw beads from jars of known ratios; decide which jar they come from. Fewer draws = jumping to conclusions bias. | Huq, Garety, & Hemsley, 1988 | [Ms](https://www.millisecond.com/download/library/beadstask/) |
| Moral Foundations Questionnaire | Rate the relevance of moral principles (care, fairness, loyalty, authority, purity) to moral judgments. | Graham et al., 2011 | [Ms](https://www.millisecond.com/download/library/moralfoundations/) |

### Perception

| Task | Description | Key Reference | Implementations |
|------|-------------|---------------|-----------------|
| Mental Rotation | Judge whether two rotated 3D objects are same or mirror images. RT scales with angular disparity. | Shepard & Metzler, 1971 | [PT](https://www.psytoolkit.org/experiment-library/mentalrotation.html) · [Ms](https://www.millisecond.com/download/library/mentalrotation/) |
| Gabor Patch Detection | Detect presence/orientation of Gabor patches at varying contrasts. Measures visual sensitivity. | Watson & Pelli, 1983 | [jsPsych](https://github.com/kurokida/jspsych-psychophysics) · [jsPsych](https://github.com/kogpsy/jspsych-gabor-stimulus-plugin) |
...
| Psychophysical Staircase | Stimulus intensity adjusted trial-by-trial to converge on perceptual threshold. | Levitt, 1971 | [jsPsych](https://github.com/kurokida/jsQuestPlus) · [JS](https://github.com/hadrienj/StaircaseJS) |
| Binocular Rivalry | Different images to each eye; perception alternates. Probes perceptual competition and conscious awareness. | Blake & Logothetis, 2002 | [PsychoPy](https://github.com/janfreyberg/binocular-rivalry) |
...
| Temporal Order Judgment (TOJ) | Report which of two stimuli appeared first. Measures temporal resolution. | Sternberg & Knoll, 1973 | [jsPsych](https://github.com/bjoluc/jspsych-toj-experiments) |
...
| Self-Paced Reading | Press a key to reveal each word; reading times at critical regions reveal parsing strategies. | Just, Carpenter, & Woolley, 1982 | [jsPsych](https://github.com/jspsych/jspsych-contrib/tree/main/packages/plugin-self-paced-reading) |
| Visual World Paradigm | Eye movements to objects during spoken language reveal real-time word recognition. | Tanenhaus et al., 1995 | [Python](https://github.com/aufrank/VisualWorld) |
...
| Oral Reading Recognition | Read aloud single words of increasing difficulty. NIH Toolbox reading decoding measure. | Gershon et al., 2014 | [NIH Toolbox](https://www.healthmeasures.net/explore-measurement-systems/nih-toolbox) |

### Social Cognition

| Task | Description | Key Reference | Implementations |
|------|-------------|---------------|-----------------|
| Reading the Mind in the Eyes (RMET) | Infer mental states from photographs of the eye region. Measures advanced theory of mind. | Baron-Cohen et al., 2001 | [Ms](https://www.millisecond.com/download/library/readingthemindintheeyes/) |
| Implicit Association Test (IAT) | Rapidly categorize stimuli along two dimensions; RT difference measures implicit bias. | Greenwald, McGhee, & Schwartz, 1998 | [PT](https://www.psytoolkit.org/experiment-library/iat.html) · [Ms](https://www.millisecond.com/download/library/iat/) |
...
| Cyberball | Virtual ball-tossing game where the participant is gradually excluded. Measures social exclusion effects. | Williams, Cheung, & Choi, 2000 | [Ms](https://www.millisecond.com/download/library/cyberball/) · [PsychoPy](https://github.com/azaleara/cyberball) · [JS](https://github.com/CuddleBunny/osu-cyberball) |
...
| Gaze Cueing | A central face looks left/right before a target. Measures automatic social attention following. | Friesen & Kingstone, 1998 | [Ms](https://www.millisecond.com/download/library/gazecueing/) |
...
| Director Task | Take into account another person's visual perspective when selecting objects. Measures perspective-taking. | Keysar et al., 2000 | [PsychoPy](https://github.com/pomodoren/psychopy-directortask) |
...
| Task | Description | Key Reference | Implementations |
|------|-------------|---------------|-----------------|
| Alternate Uses Task (AUT) | Generate as many unusual uses for a common object (e.g., brick) as possible. Scores fluency, flexibility, and originality. | Guilford, 1967 | [Ms](https://www.millisecond.com/download/library/alternateuses/) |
| Remote Associates Test (RAT) | Given three words (e.g., "falling, actor, dust"), find a fourth linking them all ("star"). Measures convergent creative thinking. | Mednick, 1962 | [Ms](https://www.millisecond.com/download/library/remoteassociates/) |
| Compound Remote Associates (CRA) | Given three compound-word stems, find the word that completes all three. Modernized RAT variant. | Bowden & Jung-Beeman, 2003 | [PsychoPy](https://github.com/aesthetiffs/Compound-Remote-Associates-PsychoPy2) |
...
| Perceptual Confidence / Meta-d' | After perceptual discrimination, rate confidence. Meta-d' quantifies metacognitive sensitivity independently of task performance. | Maniscalco & Lau, 2012 | [MATLAB](https://github.com/metacoglab/meta_dots) · [Python](https://github.com/subjectivitylab/metadPy) |
...
| Task | Description | Key Reference | Implementations |
|------|-------------|---------------|-----------------|
| Finger Tapping Task | Tap a key as fast as possible (or at a specified rate). Measures motor speed, rhythm, and lateralization. | Reitan & Wolfson, 1985 | [Ms](https://www.millisecond.com/download/library/fingertapping/) |
...
| Fitts's Law Pointing | Move to targets of varying distance and width. Movement time scales logarithmically with index of difficulty. | Fitts, 1954 | [PT](https://www.psytoolkit.org/experiment-library/fitts.html) · [JS](https://github.com/SimonWallner/uit-fitts-law) |
...
| Mirror Tracing | Trace a shape while viewing only a mirror reflection. Measures visuomotor adaptation and procedural learning. | Milner, 1962 | [JS](https://github.com/rcalinjageman/mirror_trace) |
| Visuomotor Rotation Task | Cursor feedback is rotated relative to hand movement; participants adapt reaching over trials. Measures sensorimotor adaptation. | Krakauer, 2009 | [JS](https://github.com/alan-s-lee/OnPoint) |
...
| Subitizing | Enumerate briefly flashed dot arrays. Fast and accurate for 1–4 items (subitizing range), slower beyond. | Kaufman et al., 1949 | [JS](https://github.com/flowersteam/cognitive-testbattery) |
